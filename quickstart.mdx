...
<CardGroup cols={2}>
  <Card title="Build your First Agent" icon="user-astronaut" href="https://mintlify.com/docs/settings/global">
    Quick deployment of your first AI Phone Agent with powerful customization options.
  </Card>

  <Card title="Test & Deploy" icon="vial" href="https://mintlify.com/docs/api-playground/openapi">
