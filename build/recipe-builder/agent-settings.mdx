...
Global settings provide the "vibe" and ruleset that individual nodes inherit. While a specific node might handle a specialized task like "Booking a Room," the **AI Agent Persona** ensures the way the room is booked feels consistent with the start of the call. 
